...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {ME_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-ME</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>Maine Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-ME", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-ME analyzes ACCESS for ELLs domain data and MAST results across Maine districts.</p>
        <p>~8,000 English Learners | ~192 districts | <strong>Refugee surge: Somali, Congolese, Afghan</strong></p>
        <p>Portland 25% EL | Lewiston 25% EL | MAST via NWEA MAP</p>
